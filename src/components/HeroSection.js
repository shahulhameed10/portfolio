...
import CV from "../data/Shahul_Hameed_resume.pdf";
		...
		<div className='hero-section' name='home' id='home'>
			...
			<motion.div
				...
				<p className='hero-intro'>
					<span>SHAHUL HAMEED</span>
				</p>
				<p className='hero-desc'>
					Aspiring<span className='hero-desc-sub'> Software Developer</span>
				</p>
			</motion.div>
			<motion.span
				...
				initial='hidden'
				whileInView='visible'>
				<a href={CV} download='Shahul_Hameed-Resume' className='hero-contact'>
